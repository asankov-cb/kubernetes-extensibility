...
import (
	...
	"github.com/asankov-cb/kubernetes-extensibility/controllers"
...
func main() {
	...
	if err = (&controllers.ConferenceTalkReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ConferenceTalk")
		os.Exit(1)
	}
